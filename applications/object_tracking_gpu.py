...
if len(physical_devices) > 0:
    ...
    print("GPU found for Tracking Application")
else:
    print("GPU NOTTTTT found for Tracking Application")
...
def track(request, request_received_time_ms):
    ...
    # Convert image to float and scale pixel values to [0, 1]
    ...
    for obj in tracked_objects:
        ...
        cv2.putText(frame, f"{obj['id']}", (int(bbox[0]), int(bbox[1])-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0, 0, 255), 2)
