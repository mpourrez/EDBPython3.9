        ...
        with open("msg.txt", "r") as readOutput:
            ...
            for line in processInfo:
                ...
                if processName == "iperf3 -s -D":
                    print(
                        "Information collection for \'iperf3 -s -D\' complete. PId for this process is %s" % fields[0])
                    pid = fields[0]
                    ...
                    print(
                        "Obatained process name %s does not match with the required process name \'iperf3 -s -D\'.\n" % processName)
                    print("Maybe This process has been already terminated.\n")
                    print(
                        "---------------------------------------------------------------------------------------------------------------------------\n")

            functionEndTime = t.time()
            print("The function has executed successfully in {:.2f} seconds.\n".format(endTime - startTime))
            print("Entire function iperf3 executed in {:.2f} seconds.\n".format(functionEndTime - functionStartTime))
            print(
                "---------------------------------------------------------------------------------------------------------------------------\n")
