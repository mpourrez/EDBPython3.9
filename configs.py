...
# EDGE_DEVICES_IP = ['192.168.0.151']
EDGE_DEVICES_IP = ['192.168.2.146']
# EDGE_DEVICES_IP = ['192.168.0.151', '192.168.0.12', '192.168.0.139']
...
FAULTS = [
    # Fault('memory-contention', 'MEM', '--vm 0 --vm-method all --vm-bytes', ['80%']),
    # Fault('memory-contention', 'MEM', '--vm 0 --vm-method all --vm-bytes', ['20%']),
    Fault('cpu-overload', 'CPU', '--cpu 0 --cpu-load', ['20']),
